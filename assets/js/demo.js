...
var statisticsChart = new Chart(ctx, {
    ...
    datasets: [
      {
        ...
        borderWidth: 2,
        data: [
          154, 184, 175, 203, 210, 231, 240, 278, 252, 312,
          320, 374,
        ],
      },
      {
        ...
        borderWidth: 2,
        data: [
          256, 230, 245, 287, 240, 250, 230, 295, 331, 431,
          456, 521,
        ],
      },
      {
  ...
  options: {
    ...
    legendCallback: function (chart) {
      var text = [];
      text.push(
        '<ul class="' + chart.id + '-legend html-legend">'
      );
...
var myLegendContainer =
  document.getElementById("myChartLegend");

// generate HTML legend
myLegendContainer.innerHTML =
  statisticsChart.generateLegend();

// bind onClick event to all LI-tags of the legend
var legendItems =
  myLegendContainer.getElementsByTagName("li");
...
$("#activeUsersChart").sparkline(
  [
    112, 109, 120, 107, 110, 85, 87, 90, 102, 109, 120, 99,
    110, 85, 87, 94,
  ],
  {
    type: "bar",
    ...
    datasets: [
      {
        ...
        pointHitRadius: 5,
        data: [
          20, 10, 18, 14, 32, 18, 15, 22, 8, 6, 17, 12, 17,
          18, 14, 25, 18, 12, 19, 21, 16, 14, 24, 21, 13,
          15, 27, 29, 21, 11, 14, 19, 21, 17,
        ],
      },
    ],
  },
