            ...
            <div class="row">
              ...
              <div class="col-lg-2 pl-0">
                <div class="form-group pt-3">
                  ...
                  <a href="modules/laporan-barang-keluar/export.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" target="_blank" class="btn btn-success btn-round btn-block mt-4">
                    <span class="btn-label"><i class="fa fa-file-excel mr-2"></i></span> Excel
                  </a>
                </div>
              </div>
            </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-title">
            <i class=></i> Laporan Tanggal <strong> <?php echo $tanggal_awal; ?> </strong> s.d. <strong> <?php echo $tanggal_akhir; ?> </strong>
          </div>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            ...
            <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
              ...
              <tbody>
                ...
                // sql statement untuk menampilkan data dari tabel "tbl_barang_keluar" dan tabel "tbl_barang" berdasarkan "tanggal"
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td width="70" class="text-right"><?php echo $data['satuan_barang']; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
