      ...
      <form action="modules/barang-masuk/proses_entri.php" method="post" class="needs-validation" novalidate>
        <div class="card-body">
          <div class="row">
            <div class="col-md-7">
              <div class="form-group">
                ...
                // menambahkan karakter "LS-" diawal dan karakter "1" disebelah kiri nomor urut
                $id_transaksi = "LS-" . str_pad($nomor_urut, 5, "1", STR_PAD_LEFT);
                ?>
          ...
          <div class="row">
            ...
            <div class="col-md-5 ml-auto">
            <div class="form-group">
              <label>Jumlah Brang Masuk <span class="text-danger">*</span></label>
    ...
    $(document).ready(function() {
      ...
      $('#jumlah').keyup(function() {
        ...
        // jika "jumlah" diisi 0
          ...
          $('#pesan').html('<div class="alert alert-notify alert-warning alert-dismissible fade show" role="alert"><span data-notify="icon" class="fas fa-exclamation"></span><span data-notify="title" class="text-warning">Perhatian!</span> <span data-notify="message">Jumlah masuk tidak boleh 0</span><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
          // reset input "jumlah"
          $('#jumlah').val('');
          // total stok kosong
          var total_stok = "";
