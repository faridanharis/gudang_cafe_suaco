  ...
  if (isset($_GET['pesan'])) {
    ...
    elseif ($_GET['pesan'] == 2) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              <span data-notify="icon" class="fas fa-check"></span> 
              <span data-notify="title" class="text-success">Sukses!</span> 
              <span data-notify="message">Berhasil diubah</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    elseif ($_GET['pesan'] == 4) {
      ...
      echo '<div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Username <strong>' . $username . '</strong> Username sudah ada. Silahkan ganti</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    <div class="page-inner py-45">
      <div class="d-flex align-items-left align-items-md-top flex-column flex-md-row">
        <div class="page-header text-white">
          <!-- judul halaman -->
          <h4 class="page-title text-white"><i class="fas fa-user mr-2"></i>User</h4>
        </div>
        <div class="ml-md-auto py-2 py-md-0">
          <!-- tombol entri data -->
          <a href="?module=form_entri_user" class="btn btn-secondary btn-round mr-2">
            <span class="btn-label"><i class="fa fa-plus mr-2"></i></span> Tambah User
          </a>
        </div>
      </div>
    </div>
                ...
                <tr>
                  ...
                  <td width="70" class="text-center">
                    <div>
                      ...
                      <!-- tombol hapus data -->
                      <a href="modules/user/proses_hapus.php?id=<?php echo $data['id_user']; ?>" onclick="return confirm('Yakin ingin menghapus data user<?php echo $data['username']; ?>?')" class="btn btn-icon btn-round btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Hapus">
