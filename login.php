<!-- Title -->
<title>Sistem Informasi Inventory Barang Cafe Suaco</title>
...
<body class="login">
  ...
  if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
      ...
      echo '<div class="alert alert-notify alert-danger alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Username atau Password salah</span>
    ...
    elseif ($_GET['pesan'] == 2) {
      ...
      echo '<div class="alert alert-notify alert-warning alert-dismissible fade show" role="alert">
              ...
              <span data-notify="title" class="text-warning">Perhatian!</span> 
              <span data-notify="message">Login terlebih dahulu</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
    ...
    elseif ($_GET['pesan'] == 3) {
      ...
      echo '<div class="alert alert-notify alert-success alert-dismissible fade show" role="alert">
              ...
              <span data-notify="message">Berhasil logout</span>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>';
  ...
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      <!-- logo -->
      <div class="text-center mb-4"><img src="assets/img/suacologo.png" alt="Logo" width="95px"></div>
      <!-- judul -->
      <h3 class="text-center">Sistem Informasi Inventory<br>Barang Cafe Suaco</h3>
      <!-- form login -->
